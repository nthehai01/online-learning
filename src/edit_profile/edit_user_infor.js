...
const User_edit = () => {
        ...
        const { handleChange, handlesubmit, State, error_message } = Handle_edit_user_infor(Validate_edit);
        ...
        return ( <
                ...
                noValidate > { /* <p> Username: {user2_Ed.username}  </p> */ } <
                            ...
                            placeholder = 'Paste link your picture' / > < br / > {
                                ...
                                placeholder = 'Enter your password' / > < br / > {
                                    ...
                                    placeholder = 'Enter your confirmpassword' / > < br / > {
                                        ...
                                        div className = 'form-inputs' >
                                        <
                                        label className = 'label-form' > < b > Are you a teacher ? (Answer: yes / no) < /b>   </label > < br / >
                                        <
                                        input type = "text"
                                        name = 'role'
                                        value = { State.role }
